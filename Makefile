srcdir = /home/namai/work/php/php-5.3.8/ext/pdo_namy_pool
builddir = /home/namai/work/php/php-5.3.8/ext/pdo_namy_pool
top_srcdir = /home/namai/work/php/php-5.3.8/ext/pdo_namy_pool
top_builddir = /home/namai/work/php/php-5.3.8/ext/pdo_namy_pool
EGREP = grep -E
SED = /bin/sed
...
RE2C = exit 0;
AWK = gawk
PDO_NAMY_POOL_SHARED_LIBADD = -laprutil-1 -lapr-1 -Wl,-rpath,/usr/local/lib/mysql -L/usr/local/lib/mysql -lmysqlclient -Wl,-rpath,/usr/local/lib -L/usr/local/lib -lnamy_pool
shared_objects_pdo_namy_pool = pdo_namy_pool.lo namy_pool_driver.lo namy_pool_statement.lo
PHP_PECL_EXTENSION = pdo_namy_pool
PHP_MODULES = $(phplibdir)/pdo_namy_pool.la
PHP_ZEND_EX =
...
prefix = /usr
phplibdir = /home/namai/work/php/php-5.3.8/ext/pdo_namy_pool/modules
...
EXTRA_LDFLAGS =
EXTRA_LIBS =
#INCLUDES = -I/usr/include/php -I/usr/include/php/main -I/usr/include/php/TSRM -I/usr/include/php/Zend -I/usr/include/php/ext -I/usr/include/php/ext/date/lib -I/include
INCLUDES = -I./include -I../../ -I../../include -I../../main -I../../Zend -I../../TSRM -I../../ext -I/usr/local/include/mysql -I/usr/include/httpd -I/usr/include/apr-1 -I/usr/include/aprutil-1
LFLAGS =
LDFLAGS =
SHARED_LIBTOOL =
